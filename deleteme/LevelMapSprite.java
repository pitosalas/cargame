...
//
public class LevelMapSprite extends TiledSprite {
...
//	}
	...
	public static void loadResources(CommonActivity ctx, WorldAnd gameCtx) {
		...
		gameCtx.engine.getTextureManager().loadTextures(roadTilesTextureAtlas, parkTilesTextureAtlas);

	}
	
//	Return one of the two texture regions depnding on whether this Tile is for road or park
	static private TiledTextureRegion roadOrParkTextureRegion(TileModel t) {
	...
	TileImageType getTileTypefromTile(TileModel t) {
